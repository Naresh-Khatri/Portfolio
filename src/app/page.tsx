    ...
    <SmoothScroll>
      ...
      <main style={{ height: "100dvh" }}>
        <div className="flex flex-col items-center justify-center w-full h-full overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black overflow-x-hidden">
          ...
          <h1 className="font-thin text-4xl text-transparent duration-1000 bg-white cursor-default text-edge-outline animate-title font-display sm:text-4xl md:text-7xl whitespace-nowrap bg-clip-text ">
            Hi, I am <br className="md:hidden" /> Naresh Khatri
          </h1>
          {/* <div className="hidden w-screen h-px animate-glow md:block animate-fade-right bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" /> */}
          <h1 className="mt-4 font-thin text-xl text-transparent duration-1000 bg-zinc-400 cursor-default text-edge-outline animate-title font-display sm:text-xl md:text-xl whitespace-nowrap bg-clip-text ">
